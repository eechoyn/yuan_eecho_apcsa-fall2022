...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
  ...
  {
//    Picture pix = new Picture("/Users/eechoyuan/Desktop/Unit16-Assignments-pixLab/images/moon-surface.jpg");
//    pix.explore();
    
    Picture test = new Picture("/Users/eechoyuan/Desktop/ano/pictures/house.jpg");
    test.scale(0.25, 0.25); 
    test.explore();
  }
